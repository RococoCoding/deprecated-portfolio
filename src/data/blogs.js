const blogs = [
  ...
  },
  {
    ...
    text: `One of the things I wished they'd talked more about at the school was planning your app. Early on, I would just start writing the first thing on the page I wanted to see and went from there. After learning advanced state management, I was finally able to see the big picture, and now I can think about planning an app much easier than I did before. If you're new to coding and want some tips on how to plan your apps before you code, here's what I've learned.

    The first thing to do is try and visualize the page and how you would want it to look. This doesn't have to be a design thing -- just focus on a simple wireframe type of site. What are the main elements? Say, header, nav, page components. Then you dig down. What's inside of those? Links, information, icons, images. Write it all down. 
